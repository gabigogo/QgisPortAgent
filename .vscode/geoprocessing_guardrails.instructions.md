---
applyTo: "**/*.{py,pyt,tbx,atbx,qgs,qgz}"
description: "Shared Geoprocessing Guardrails for plugin creation, migration, and MCP execution"
---

# Shared Geoprocessing Guardrails

This is the authoritative geoprocessing guardrail policy for all plugin-related agents.
Apply these rules when creating new plugins, migrating ArcGIS tools, or executing
distance-sensitive workflows through QGIS MCP.
